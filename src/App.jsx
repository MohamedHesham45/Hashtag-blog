  ...
  return (
    <>
      <BrowserRouter>
        ...
        <Routes>
          <Route  path="/" element={isLogin ? <Navigate to="/home" /> : <Login url={url} setIsLogin={setIsLogin} />} />
          <Route path="/signup" element={<SignUp url={url} />} />

          <Route path="/home" element={<ProdectedRouter isLogin={isLogin}><Posts url={url} /></ProdectedRouter>} />
          <Route path="/profile" element={<ProdectedRouter isLogin={isLogin}><Profile url={url}/></ProdectedRouter>}></Route>
        </Routes>
      </BrowserRouter>
    </>
  );
